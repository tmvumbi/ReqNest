...
namespace ReqNest.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260710151459_InitialProductModel")]
            ...
            modelBuilder.Entity("ReqNest.Core.Tickets.TicketWatcher", b =>
                {
                    ...
                    b.HasKey("TicketId", "UserId")
                        .HasName("pk_ticket_watcher");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_ticket_watcher_user_id");

                    b.ToTable("ticket_watcher", (string)null);
                });
            ...
            modelBuilder.Entity("ReqNest.Core.Tickets.TicketWatcher", b =>
                {
                    b.HasOne("ReqNest.Core.Tickets.Ticket", "Ticket")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_ticket_watcher_tickets_ticket_id");
                    ...
                    b.HasOne("ReqNest.Core.Identity.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_ticket_watcher_users_user_id");
