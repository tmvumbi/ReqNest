...
const english = {
  ...
  'nav.integrations': 'Portal & integrations',
  'nav.settings': 'Company settings',
  'nav.audit': 'Audit log',
  'nav.workspace': 'Workspace',
  'nav.admin': 'Admin',
  'nav.board': 'Board',
  'nav.searchPlaceholder': 'Search tickets…',
  ...
  'profile.summary': 'Update your name, password, and profile image.',
  ...
  'tickets.boardView': 'Board',
  'tickets.listView': 'List',
  'tickets.commentRequired': 'This transition requires a comment:',
  ...
  'tickets.createSummary': 'Describe the request and route it to the right project.',
  ...
  'notifications.viewAll': 'View all & settings',
...
const french: Record<TranslationKey, string> = {
  ...
  'nav.integrations': 'Portail et intégrations',
  'nav.settings': "Paramètres de l'entreprise",
  'nav.audit': "Journal d'audit",
  'nav.workspace': 'Espace de travail',
  'nav.admin': 'Administration',
  'nav.board': 'Tableau',
  'nav.searchPlaceholder': 'Rechercher des tickets…',
  ...
  'profile.summary': 'Mettez à jour votre nom, votre mot de passe et votre image de profil.',
  ...
  'tickets.boardView': 'Tableau',
  'tickets.listView': 'Liste',
  'tickets.commentRequired': 'Cette transition nécessite un commentaire :',
  ...
  'tickets.createSummary': 'Décrivez la demande et dirigez-la vers le bon projet.',
  ...
  'notifications.viewAll': 'Tout voir et paramètres',
...
export class I18nService {
  ...
  ticketActivityAction(action: string): string {
    const catalog: Record<string, readonly [string, string]> = {
      ...
      'requester.ticket.created': [
        'Requester created the ticket',
        'Le demandeur a créé le ticket',
      ],
      'requester.ticket.commented': ['Requester commented', 'Le demandeur a commenté'],
    };
